...
public class StartPanelSwing extends JPanel implements StartPanel {
    private JComboBox<String> shapeCombo;
    private JComboBox<Integer> playerCombo;
    private JComboBox<Integer> tokenCombo;

    public StartPanelSwing(ActionListener onStart) {
    ...
    @Override
    public int getSelectedPlayerCount() { return (int) playerCombo.getSelectedItem(); }
    @Override
    public int getSelectedTokenCount() { return (int) tokenCombo.getSelectedItem(); }
    @Override
    public String getSelectedShapeType() { return (String) shapeCombo.getSelectedItem(); }
}