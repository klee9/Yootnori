...
//                        }
    ...
    public int checkAutoControl() {
        ...
        System.out.println("currentToken: " + currentToken.getId());
        System.out.println("stacked size: " + currentToken.getStackedTokens().size());
        System.out.println("allStacked: " + allStacked);
        ...
        if (allStacked || cnt == 0 || getCurrentPlayer().getRemainingTokens() == 1 && YutResults.size() == 1) {
...
//
//        for (Token t : tokens) {
//            System.out.println("current token: " + currentToken.getId() + ", t: " + t.getId());
//            Token baseToken = t;
...
//        System.out.println("도착 노드에 있는 독립적인 말의 개수" + count);
//        return count;
//    }
