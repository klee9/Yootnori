...
import ui.interfaces.BoardPanel;

import java.util.*;

public class BoardPanelFX extends Pane implements BoardPanel {
    ...
    public Point2D getNodePosition(int idx) {
    ...
    private void drawLineEdgeToEdge(GraphicsContext gc, Point2D from, Point2D to, int cellSize, int offsetX, int offsetY) {
    ...
    // tokenPanel 에서 호출해야 되므로  public 으로 수정
    public double toPixelX(double x, int cellSize, int offsetX) { return offsetX + x * cellSize; }
    public double toPixelY(double y, int cellSize, int offsetY) { return offsetY + y * cellSize; }
